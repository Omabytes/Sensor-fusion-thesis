...
\vspace*{5mm}
\begin{center}
\includegraphics[scale=0.6]{logos/bristollogo_colour}\\
\vspace{20mm}
\rule[0.5ex]{\linewidth}{2pt}\vspace*{-\baselineskip}\vspace*{3.2pt}
\rule[0.5ex]{\linewidth}{1pt}\\[\baselineskip]
{\HUGE Sensor Fusion }\\[4mm]
{\Large \textit{Characterisation and the Kalman Filter}}\\
\rule[0.5ex]{\linewidth}{1pt}\vspace*{-\baselineskip}\vspace{3.2pt}
\rule[0.5ex]{\linewidth}{2pt}\\
\vspace{6.5mm}
{\large By}\\
\vspace{6.5mm}
{\large\textsc{Robert George Bragg}}\\
\vspace{15mm}
