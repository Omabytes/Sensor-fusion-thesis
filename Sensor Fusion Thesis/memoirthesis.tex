...
\pdfinfo{
   /Author (Robert Bragg)
   /Title (Sensor Fusion, Characterisation and the Kalman Filter)
   /Keywords (Sensor; Fusion; Kalman)
...
\usepackage{lettrine}
\newcommand{\initial}[1]{%
	\lettrine[lines=2,lhang=0.33,nindent=0.3em]{
		\color{gray}
     		{\textsc{#1}}}{}}
%
...
\includepdf[pages={1}]{frontmatter/title.pdf}
